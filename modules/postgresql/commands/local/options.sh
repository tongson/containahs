...
# Created: Mon Dec  3 14:22:04 PST 2018
#
#/ usage: postgresql:local [ --postgresql <"9.6">] [ --debian <"stable">] 
...
rerun_options_parse() {
    ...
    [[ -z "$DEBIAN" ]] && DEBIAN="$(rerun_property_get $RERUN_MODULE_DIR/options/debian DEFAULT)"
